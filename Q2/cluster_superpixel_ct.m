% cluster superpixels according to their texture color-texture features
...
vectors = get_color_texture_vectors(img_name);

% use kmeans clustering method
[IDX, C, SUMD, D] = kmeans(vectors', 3, 'Replicates', 12);
